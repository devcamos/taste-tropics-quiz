              ...
              <div className="bg-gradient-to-r from-orange-50 to-red-50 p-6 rounded-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-700">Your unique flavor personality</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Heart className="w-5 h-5 text-red-500" />
                    <span className="text-gray-700">Perfect product matches</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Leaf className="w-5 h-5 text-green-500" />
                    <span className="text-gray-700">Personalized cooking tips</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Star className="w-5 h-5 text-yellow-500" />
                    <span className="text-gray-700">Your culinary mantra</span>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl p-8 shadow-2xl">
            <div className="text-center mb-8">
              ...
              <div className="bg-gradient-to-r from-orange-50 to-red-50 p-4 rounded-2xl">
                <p className="text-lg text-gray-700 italic">"{personality.mantra}"</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">{personality.description}</p>
                ...
                <div>
                  ...
                  <div className="bg-gradient-to-r from-yellow-50 to-orange-50 p-4 rounded-2xl border-l-4 border-orange-500">
                    <p className="text-gray-700 italic">{personality.cookingTip}</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  {personality.products.map((product, index) => (
                    <div key={index} className="bg-gradient-to-r from-orange-50 to-red-50 p-4 rounded-xl border hover:shadow-md transition-shadow">
                ...
                <div className="mt-6 p-4 bg-gradient-to-r from-green-50 to-blue-50 rounded-xl">
                  ...
                  <p className="text-sm text-gray-700">Get 20% off your first Taste Tropics order when you mention your personality type: <strong>{personality.title.slice(2)}</strong></p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-4">
            {questions[currentQuestion].options.map((option, index) => (
              <button
                ...
                className="w-full p-6 text-left bg-gradient-to-r from-orange-50 to-red-50 rounded-2xl border-2 border-transparent hover:border-orange-300 hover:shadow-lg transform hover:scale-105 transition-all duration-200"
              >
                <div className="flex items-center justify-between">
